...
@Component({
  selector: 'app-edit-subscribed-service',
  templateUrl: './edit-subscribed-service.component.html',
  styleUrls: ['./edit-subscribed-service.component.scss']
})
export class EditSubscribedServiceComponent implements OnInit {
  ...
  navigateBack(){
    this.router.navigate(["/content/home/subscribed-service"]);
  }
