...
export class ViewProductServiceComponent implements OnInit {
  ...
  subscriber(){
    let payload = {
      ...
      serviceId:this.serviceDetailsData.serviceId,
      serviceDetailsId:this.serviceDetailsData.serviceDetailsId,
