...
@Component({
  selector: 'app-view-product-billing',
  templateUrl: './view-product-billing.component.html',
  styleUrls: ['./view-product-billing.component.scss']
})
export class ViewProductBillingComponent implements OnInit {
  ...
  navigateBack(){
    this.router.navigate(["/content/home/product-billing"]);
  }
