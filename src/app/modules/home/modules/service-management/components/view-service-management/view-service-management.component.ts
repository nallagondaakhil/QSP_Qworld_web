...
@Component({
  selector: "app-view-service-management",
  templateUrl: "./view-service-management.component.html",
  styleUrls: ["./view-service-management.component.scss"],
})
export class ViewServiceManagementComponent implements OnInit {
  actionItems!: any;
  copyActionitems!: any;
  statusItems!: any;
  ...
  editServiceManagement(data: any) {
    this.router.navigate([`/content/home/service-management/edit/${data.serviceId}`], {
      queryParams: { serviceDetailsId: data.serviceDetailsId },
    });
  }
